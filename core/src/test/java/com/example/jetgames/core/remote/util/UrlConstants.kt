...
// path
internal const val GAMES_URL_PATH = "$REQUEST_PATH?page=$PAGE&page_size=$SIZE&key=&ordering=$ORDERING&search_exact=$SEARCH_EXACT"
internal const val GAMES_URL_W_SEARCH_QUERY_PATH = "$REQUEST_PATH?page=$PAGE&page_size=$SIZE&key=&ordering=$ORDERING&search=$SEARCH_QUERY&search_exact=$SEARCH_EXACT"
internal const val GAMES_URL_W_NO_MATCH_QUERY_PATH = "$REQUEST_PATH?page=$PAGE&page_size=$SIZE&key=&ordering=$ORDERING&search=$NO_MATCH_SEARCH_QUERY&search_exact=$SEARCH_EXACT"
internal const val DETAILS_URL_PATH = "$REQUEST_PATH/$ID?key="
internal const val PLATFORMS_URL_PATH = "$PLATFORMS_PATH?key="
